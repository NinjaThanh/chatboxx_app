...
class IncomingAllPage extends StatelessWidget {
  ...
  Widget call(){
    return Padding(padding: EdgeInsets.symmetric(vertical: 120),
      child:  Align(
      alignment: Alignment.bottomCenter,
      child: Padding(
        padding: EdgeInsets.only(bottom: 60), // Adjust positioning
        child: Container(
          width: 350, // Adjust width to match the iOS style
          height: 60,
          decoration: BoxDecoration(
          ...
          child: ActionSlider.standard(
            ...
            width: 350,
            backgroundColor: Colors.green.withOpacity(0.2), // Soft transparent effect
            toggleColor: Colors.white, // Toggle matches iOS style
            height: 60,
            ...
            child: Text(
              ...
              style: TextStyle(
                ...
                color: Colors.white, // Matches iOS text color
              ),
            ),
          ),
        ),
